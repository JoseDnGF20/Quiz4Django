"""
Django settings for QuizDjango project.
...
SECRET_KEY = 'django-insecure-e&^tc7v9)-f(rq5%bbt9#+h0(v3gudm$l-@cznt-00hpek6g-q'
...
WSGI_APPLICATION = 'QuizDjango.wsgi.application'
